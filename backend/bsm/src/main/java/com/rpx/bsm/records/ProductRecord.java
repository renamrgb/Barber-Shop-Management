...
public record ProductRecord(
        ...
        @Length(min = 2, max = 60, message = "O campo 'título' deve conter até 60 caracteres")
        String title,
        @NotNull
        ...
        String brand,
        @NotNull
        @Min(value = 0, message = "O campo 'quantidade' deve ser maior ou igual a 0")
        Integer quantity,
        ProductProcedureType productType,
        @NotNull
        Boolean isActive
) {
}
