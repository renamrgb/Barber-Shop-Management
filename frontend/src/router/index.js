    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: '/schedule/block/get',
            name: 'Consultar Bloqueios',
            component: () => import('@/views/blockedTime/BlockedTimeGet.vue'),
          },
          {
            path: '/schedule/block/create',
            name: 'Registrar Bloqueio',
            component: () =>
              import('@/views/blockedTime/BlockedTimeCreate.vue'),
          },
          {
            path: '/schedule/block/get/:id',
            name: 'Consultar Bloqueio',
            component: () =>
              import('@/views/blockedTime/BlockedTimeCreate.vue'),
          },
        ],
